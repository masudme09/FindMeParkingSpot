defmodule ParkinWeb.Router do
  ...
  scope "/", ParkinWeb do
    ...
    post "/parking/summary", ParkingsearchController, :summary
    get "/parking/summary/:placename", ParkingsearchController, :summary_details
  ...
  scope "/", ParkinWeb do
    pipe_through [:browser_auth, :ensure_auth]
